...
server_1.default.post('/getListaOrariDisponibili', function (request, response) { return SegretariController_1.default.getListaOrariDisponibili(request, response); });
